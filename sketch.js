...
function prelaod(){
  this.bg1 = loadImage("sprites/project(32)bg1.png image.jpg")
  this.bg2 = loadImage("sprites/project(32)bg2.png image.jpg")
  changebg()
}
...
console.log(hour)
if(hour>=6 && hour<18){
bg = "sprites/project(32)bg1.png image.jpg"
}
else{
  bg = "sprites/project(32)bg2.png image.jpg"
}
